...
namespace liu
{
    ...
    public class PointAxis : MonoBehaviour
    {
        ...
        /// 没有被选中的时候，X、Y、Z轴的颜色
        /// </summary>
        public static Color colorNormalX = new Color(255, 100, 100, 255);
        public static Color colorNormalY = new Color(100, 255, 100, 255);
        public static Color colorNormalZ = new Color(100, 100, 255, 255);
