...
namespace TriLib
{
    ...
    public static class AssimpInterop
    {
        ...
        public const string DllPath = "assimpuwp";
        ...
        private static extern uint _aiMaterial_GetEmbeddedTextureDataSize(IntPtr ptrScene, uint uintIndex,
            bool boolCompressed);
        ...
        private static extern void _aiMaterial_GetEmbeddedTextureData(IntPtr ptrScene, IntPtr ptrData, uint uintIndex,
            uint uintSize);
